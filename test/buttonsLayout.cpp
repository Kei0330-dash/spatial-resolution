...
MyMainFrame::MyMainFrame(const TGWindow *p, UInt_t w, UInt_t h) : TGMainFrame(p, w, h)
{
   ...
   hframe1->AddFrame(test, new TGLayoutHints(kLHintsTop | kLHintsExpandX, 2, 0, 2, 2));
   ...
   cframe1->AddFrame(draw, new TGLayoutHints(kLHintsTop | kLHintsExpandX, 2, 2, 2, 2));
   ...
   cframe1->AddFrame(help, new TGLayoutHints(kLHintsTop | kLHintsExpandX, 2, 2, 2, 2));
