...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/otokun241/newRepository/data/SOFIST3_DATA_HV130_chip1_alpha_241009.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/otokun241/newRepository/data/SOFIST3_DATA_HV130_chip1_alpha_241009.root");
      }
